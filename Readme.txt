...
While using the back-end test automation project, I preferred the Java language. This is a Maven project. I prepared it using Junit & mashape.unirest library.

While using the UI test automation project, I still preferred the Java language. This is a Maven project. I created it using gauge framework. At the same time, Dockerfile and docker.compose.yaml are in the project.
